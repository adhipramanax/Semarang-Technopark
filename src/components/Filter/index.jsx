    ...
    return (
        <div>
            <div className="grid grid-cols-3 xl:flex xl:flex-col lg:flex lg:flex-col">
                ...
                <div className="mt-5 xl:mt-11 lg:mt-11">
                    <h1 className="font-medium text-xs xl:text-xl lg:text-xl">Daerah</h1>
                    <div className="hidden xl:block h-[3px] w-[98%] mx-auto bg-[#D9D9D9] mt-3"></div>
                    {props.daerah.map((daerah) => {
                        return (
                            <div className="flex items-center gap-2 mt-3">
                                <input type="checkbox" class="checked:bg-[#D9D9D9] rounded bg-white" name={daerah} id={daerah} />
                                <label className="label cursor-pointer text-xs xl:text-base lg:text-base font-normal" htmlFor={daerah}>{daerah}</label>
                            </div>
                        )
                    })}
                </div>
