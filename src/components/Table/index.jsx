    ...
    const check = (userid, password, alamat, kapasitas, bidang, ketua, noseri, pemilik) => {
        if (userid !== undefined) {
                    ...
                    <td className="flex w-full h-full">
                        <button className="bg-secondary rounded m-auto p-1">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M3.5 9.08984H20.5" stroke="#FFFBFF" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                ...
                                <path d="M11.9955 13.7002H12.0045" stroke="#FFFBFF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M8.29431 13.7002H8.30329" stroke="#FFFBFF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M8.29431 16.7002H8.30329" stroke="#FFFBFF" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </button>
                    </td>
                </>
            ...
            return (
                <>
                    <td>
                        <div className={`bg-${bidang.warna} rounded px-2 py-1 text-white text-center text-base font-normal`}>
                            {bidang.isi}
                        </div>
                    </td>
                    ...
                    <td className="flex w-full h-full">
                        <button className="bg-info rounded m-auto p-1">
                            <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M21.8008 7V17C21.8008 20 20.3008 22 16.8008 22H8.80078C5.30078 22 3.80078 20 3.80078 17V7C3.80078 4 5.30078 2 8.80078 2H16.8008C20.3008 2 21.8008 4 21.8008 7Z" stroke="#FFFBFF" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M15.3008 4.5V6.5C15.3008 7.6 16.2008 8.5 17.3008 8.5H19.3008" stroke="#FFFBFF" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M8.80078 13H12.8008" stroke="#FFFBFF" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M8.80078 17H16.8008" stroke="#FFFBFF" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </button>
                    </td>
                </>
            ...
            return (
                <>
                    <td>
                        <div className={`bg-${noseri.warna} rounded px-2 py-1 text-white text-center text-base font-normal`}>
                            {noseri.isi}
                        </div>
                    </td>
    ...
    const statuss = status => {
        if (status !== undefined) {
            return (
                <>
                    <td>
                        <div className={`bg-${status.warna} rounded px-2 py-1 text-white text-center text-base font-normal`}>{status.isi}</div>
                    </td>
                </>
            )
        }
            ...
            <div className="w-full bg-white rounded">
                <div className="overflow-x-auto !bg-white">
                    ...
                    <div className="flex justify-end mr-5 mt-5 gap-1">
                        ...
                        <button className="text-sm font-medium select-none h-7 cursor-pointer border-merah border-[1px] unactive w-7 rounded-tl-md rounded-br-md">1</button>
                        <button className="text-sm font-medium select-none h-7 cursor-pointer border-merah border-[1px] unactive w-7 rounded-tl-md rounded-br-md">2</button>
                        <button className="text-sm font-medium select-none h-7 cursor-pointer border-merah border-[1px] active w-7 rounded-tl-md rounded-br-md">3</button>
                        <button className="text-sm font-medium select-none h-7 cursor-pointer border-merah border-[1px] unactive w-7 rounded-tl-md rounded-br-md">4</button>
                        <button className="text-sm font-medium select-none h-7 cursor-pointer border-merah border-[1px] unactive w-7 rounded-tl-md rounded-br-md">6</button>
                        <button className="text-sm font-medium select-none h-7 cursor-pointer border-merah border-[1px] unactive w-7 rounded-tl-md rounded-br-md">
                            <svg className="m-auto" width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M10.8335 14.1667L15.0002 10L10.8335 5.83337" stroke="#CD0606" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                <path d="M5 14.1667L9.16667 10L5 5.83337" stroke="#CD0606" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </button>
                    </div>
                </div>
