  ...
  return (
    <>
      <div className="container h-full mx-auto w-full pt-2 flex flex-col justify-center items-center">
        <img
          className="absolute w-[130px] md:w-[200px] lg:w-[220px] xl:w-[320px] -left-8 lg:left-0 top-40 lg:top-[280px] z-0 md:top-44 xl:top-56"
          src="https://res.cloudinary.com/dna8dexwi/image/upload/v1663010927/semarang-technopark/side_fgroeh.png"
          alt=""
        />
        <img
          className="absolute w-[110px] md:w-[160px] lg:w-[220px] xl:w-[300px] right-0 top-[165px] z-0 md:top-48 lg:top-[280px] xl:top-52"
        ...
        <div className="absolute mt-10 h-full flex flex-col justify-center items-center ">
          ...
          <p className="w-[300px] md:w-[520px] lg:w-[720px] text-white text-[0.7em] lg:text-base text-center my-5 lg:my-10">
