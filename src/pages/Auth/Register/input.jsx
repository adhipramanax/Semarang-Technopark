    ...
    return (
        <>
            <div className="w-full xl:w-[35%] xl:mx-0 lg:w-[50%] lg:mx-0">
                <h1 className="text-white text-center text-2xl xl:text-4xl font-bold mt-0 xl:mt-3 mb-3 lg:mt-1 lg:mb-3">Daftarkan Akun</h1>
                <div className="flex flex-col items-center gap-4 py-4 xl:py-5 lg:py-4 px-6 bg-white rounded-[20px]">
                    ...
                    />
                    <div className="flex items-center w-full gap-2">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="#F08619" viewBox="0 0 24 24" strokeWidth={1.5} stroke="white" className="w-5 h-5 xl:w-6 xl:h-6 lg:w-5 lg:h-6">
                    ...
                    <div className="w-full relative block">
                        ...
                        <span className="absolute top-2.5 right-3 flex items-center pl-4">
                            {props.password ?
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 cursor-pointer" onClick={changeEyeP}>
                    ...
                    <div className="w-full relative block">
                        ...
                        <span className="absolute top-2.5 right-3 flex items-center pl-4">
                            {props.ulangPassword ?
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 cursor-pointer" onClick={changeEyeUP}>
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178z" />
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                </svg>
                                :
                    ...
                    <div className="text-sm xl:text-base lg:text-sm mt-0 xl:mt-3 lg:mt-0 flex gap-1">
                        Sudah Punya Akun?
                        <Link to="/login">
                            <span className="text-[#F08619] text-sm xl:text-base lg:text-sm hover:underline">Masuk Sekarang</span>
                        </Link>
                    </div>
                </div>
            </div>
