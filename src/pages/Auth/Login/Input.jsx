...
const input = (props) => {
  ...
  return (
    <>
      <div className="w-full h-screen xl:w-[35%] xl:mx-0 lg:w-[40%] lg:mx-0">
        <h1 className="text-white text-center text-2xl xl:text-4xl font-bold mt-2 xl:mt-12 mb-5 lg:mt-9 lg:mb-5">Masuk ke Akun</h1>
        <div className="flex flex-col items-center gap-4 py-8 px-6 bg-white rounded-[20px]">
          ...
          <div className="w-full relative block">
            ...
            <span className="absolute top-2.5 right-3 flex items-center pl-4">
              {props.password ?
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6 cursor-pointer" onClick={changeEye}>
          ...
          <div className="flex justify-between w-full">
            <div className="gap-2 flex items-center">
              ...
              <label htmlFor="ingat" className="text-sm xl:text-base lg:text-base cursor-pointer"> Ingat Saya</label>
            </div>
            <Link to="/lupa" className="cursor-pointer text-sm xl:text-base lg:text-base text-[#F08619]">Lupa Password?</Link>
          </div>
          ...
          <div className="text-sm xl:text-base lg:text-base mt-1 xl:mt-3 lg:mt-3 flex gap-1">
            Belum Punya Akun?
            <Link to="/register">
              <span className="text-[#F08619] text-sm xl:text-base lg:text-base hover:underline">Daftar Sekarang</span>
            </Link>
          </div>
        </div>
      </div>
