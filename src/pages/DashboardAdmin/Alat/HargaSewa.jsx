    ...
    return (
        <>
            <div className="w-full bg-white p-5 rounded">
                ...
                <ul className="mt-5 gap-y-3 grid grid-cols-2">
                    <li className="flex w-full">
                        <h1 className="w-[20%] text-red-500 font-semibold">Harian</h1>
                        <p className="w-[80%]">Rp. 50.000</p>
                    </li>
                    <li className="flex w-full">
                        <h1 className="w-[20%] text-red-500 font-semibold">Mingguan</h1>
                        <p className="w-[80%]">Rp. 50.000</p>
                    </li>
                    <li className="flex w-full">
                        <h1 className="w-[20%] text-red-500 font-semibold">Bulanan</h1>
                        <p className="w-[80%]">Rp. 50.000</p>
                    </li>
                    <li className="flex w-full">
                        <h1 className="w-[20%] text-red-500 font-semibold">Tahunan</h1>
                        <p className="w-[80%]">Rp. 50.000</p>
                    </li>
                </ul>
            </div>
