          ...
          <div className="flex flex-col gap-5 pb-10 mx-6 mt-20">
            ...
            <div className="w-full bg-white p-5 rounded">
              <div className="flex gap-2">
                ...
                <h1 className="text-base font-bold text-stp-primary-600">
                  Informasi Pelatihan
                </h1>
              </div>
              <div className="flex mt-3">
                <div className="w-[24.5%]">
                  <img
                    className="rounded w-[250px] h-[218px] object-cover"
                    src={IBC}
                    alt="ibc"
                  />
                </div>
                <div className="w-[65%] flex ml-10">
                  <div className="grid grid-cols-3 gap-y-6 my-auto">
                    ...
                    <p className="col-span-2">
                      Belajar bagaimana cara menjadi hacker yang baik dalam
                      melakukan pengamanan terhadap suatu website
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="w-full bg-white p-5 rounded">
              <div className="flex gap-2">
                ...
                >
                  <path
                    d="M8.67188 14.7214C8.67188 16.0114 9.66188 17.0514 10.8919 17.0514H13.4019C14.4719 17.0514 15.3419 16.1414 15.3419 15.0214C15.3419 13.8014 14.8119 13.3714 14.0219 13.0914L9.99187 11.6914C9.20187 11.4114 8.67188 10.9814 8.67188 9.76145C8.67188 8.64145 9.54187 7.73145 10.6119 7.73145H13.1219C14.3519 7.73145 15.3419 8.77145 15.3419 10.0614"
                    stroke="#D73737"
                    stroke-width="1.5"
                    stroke-linecap="round"
                    stroke-linejoin="round"
                  ...
                  />
                  <path
                    d="M12 22.3916C17.5228 22.3916 22 17.9144 22 12.3916C22 6.86875 17.5228 2.3916 12 2.3916C6.47715 2.3916 2 6.86875 2 12.3916C2 17.9144 6.47715 22.3916 12 22.3916Z"
                    stroke="#D73737"
                    stroke-width="1.5"
                    stroke-linecap="round"
                    stroke-linejoin="round"
              ...
              <div className="flex mt-3 gap-2">
                <div className="w-1/2 flex gap-5 items-center">
                  ...
                  <input
                    type="text"
                    value="100"
                    className="input input-bordered w-full max-w-xs disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none"
                    disabled
                  />
                </div>
                <div className="w-1/2 flex gap-5 items-center">
            ...
            <div className="flex justify-between">
              <div className="w-[48%] bg-white p-5 rounded">
                <div className="flex gap-2">
                  ...
                  >
                    <path
                      d="M22 12.3916C22 17.9116 17.52 22.3916 12 22.3916C6.48 22.3916 2 17.9116 2 12.3916C2 6.8716 6.48 2.3916 12 2.3916C17.52 2.3916 22 6.8716 22 12.3916Z"
                      stroke="#D73737"
                      stroke-width="1.5"
                      stroke-linecap="round"
                      stroke-linejoin="round"
                    />
                    <path
                      d="M15.7099 15.5714L12.6099 13.7214C12.0699 13.4014 11.6299 12.6314 11.6299 12.0014V7.90137"
                      stroke="#D73737"
                      stroke-width="1.5"
                      stroke-linecap="round"
                      stroke-linejoin="round"
