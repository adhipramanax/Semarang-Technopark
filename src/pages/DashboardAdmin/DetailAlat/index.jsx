          ...
          <div className="flex flex-col gap-5 pb-10 mx-6 mt-20">
            ...
            <div className="w-full flex bg-white p-5 rounded">
              <div className="w-[24.5%]">
                ...
                <div
                  id="style-2"
                  className="imgs flex flex-nowrap snap-x overflow-x-scroll snap-mandatory py-2 pl-1 gap-2 mt-5"
                  ref={ref}
                >
                  {images.map((img, index) => {
                    return (
                      <img
                        key={index}
                        className={`img snap-center snap-always rounded w-11 h-11 object-cover cursor-pointer order-${index}`}
                        src={img}
                        alt="ibc"
              ...
              <div className="w-[65%] flex ml-10">
                <div className="grid grid-cols-3 gap-y-6 my-auto">
                  ...
                  <p className="col-span-2">
                    Bendan Ngisor, Kec. Gajahmungkur, Kota Semarang, Jawa Tengah
                    50233
                  </p>
